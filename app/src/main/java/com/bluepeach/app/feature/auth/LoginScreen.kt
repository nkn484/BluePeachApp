...
fun LoginScreen(
    ...
    Scaffold(
        topBar = { BluePeachTopBar(title = "Đăng nhập", onBack = onBack) },
        ...
        Column(
            ...
            BluePeachSectionHeader(
                ...
                description = "Tài khoản sẽ lấy session token từ Supabase và tự gắn vào các API private.",
                centered = false
            )
            ...
            Surface(
                ...
                Column(
                    ...
                    com.bluepeach.app.core.ui.components.BluePeachSecondaryButton(
                    ...
                    Text(
                        text = "Tài khoản test: mobile@bluepeach.com / bluepeach123",
